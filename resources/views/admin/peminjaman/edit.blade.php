    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <form class="forms-sample" action="{{ url('admin/peminjaman/update', $peminjaman->id) }}" method="POST">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama_peminjam" name="nama_peminjam"
                      placeholder="Masukkan nama kamu" value="{{ $peminjaman->nama_peminjam }}">
              </div>
          </div>
          <div class="form-group row">
              <label for="ktp_peminjam" class="col-sm-4 col-form-label">ktp</label>
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="ktp_peminjam" name="ktp_peminjam"
                      placeholder="Masukkan no ktp" value="{{ $peminjaman->ktp_peminjam }}">
              </div>
          </div>
          <div class="form-group row">
              ...
              <div class="col-sm-8">
                  <input type="date" class="form-control" id="mulai" name="mulai"
                      placeholder="Masukkan tanggal mulai" value="{{ $peminjaman->mulai }}">
              </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
              <label for="komentar_peminjam" class="col-sm-4 col-form-label">komentar</label>
              <div class="col-sm-8">
                  <input type="text" class="form-control" id="komentar_peminjam" name="komentar_peminjam"
                      placeholder="Masukkan komentar" value="{{ $peminjaman->komentar_peminjam }}">
              </div>
          </div>
          <div class="form-group row">
